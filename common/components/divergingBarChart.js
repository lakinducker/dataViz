function DivergingBarChartController() {
  var ctrl = this;
  console.log('test DivergingBarChartController');
  ...
  var svg = d3.select('.diverging-bar-chart-area').append("svg")
...
angular.module('dataViz').component('divergingBarChart', {
  templateUrl: 'common/components/divergingBarChart.html',
  controller: DivergingBarChartController,
  bindings: {
    data: '='
  }
});