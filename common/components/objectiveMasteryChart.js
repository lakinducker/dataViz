function ObjectiveMasteryChartController() {
  var ctrl = this;
  console.log('ObjectiveMasteryChartController');
  ...
  var svg = d3.select('.objective-mastery-chart-area').append("svg")
...
angular.module('dataViz').component('objectiveMasteryChart', {
  templateUrl: 'common/components/objectiveMasteryChart.html',
  controller: ObjectiveMasteryChartController,
  bindings: {
    data: '='
  }
});